...
<head>
  ...
  ================================================== -->
    ...
    <link rel="stylesheet" href="${apps}/static/index/css/style.css">
    <link rel="stylesheet" href="${apps}/static/index/css/menu.css">
    <link rel="stylesheet" href="${apps}/static/index/css/responsiveslides.css">
    <link href="${apps}/static/index/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <script src="${apps}/static/index/js/jquery183.min.js"></script>
    <script src="${apps}/static/index/js/responsiveslides.min.js"></script>
    <script>
            ...
            <div class="slider">
                ...
                <div class="callbacks_container">
                    <ul class="rslides" id="slider">
                        <li>
                            <img src="${apps}/static/index/images/1.jpg" alt="">
                        </li>
                        <li>
                            <img src="${apps}/static/index/images/2.jpg" alt="">
                        </li>
                        <li>
                            <img src="${apps}/static/index/images/3.jpg" alt="">
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="widget wid-follow">
                            ...
                            <div class="wid-content">
                                <div class="row">
                                    <div class="col-1-3">
                                        <div class="wrap-col">
                                            <a href="#"><img src="${apps}/static/index/images/15.jpg" /></a>
                                            <a href="#"><img src="${apps}/static/index/images/16.jpg" /></a>
                                            <a href="#"><img src="${apps}/static/index/images/17.jpg" /></a>
                                        </div>
                                    </div>
                                    <div class="col-1-3">
                                        <div class="wrap-col">
                                            <a href="#"><img src="${apps}/static/index/images/18.jpg" /></a>
                                            <a href="#"><img src="${apps}/static/index/images/19.jpg" /></a>
                                            <a href="#"><img src="${apps}/static/index/images/20.jpg" /></a>
                                        </div>
                                    </div>
                                    <div class="col-1-3">
                                        <div class="wrap-col">
                                            <a href="#"><img src="${apps}/static/index/images/21.jpg" /></a>
                                            <a href="#"><img src="${apps}/static/index/images/22.jpg" /></a>
                                            <a href="#"><img src="${apps}/static/index/images/23.jpg" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
